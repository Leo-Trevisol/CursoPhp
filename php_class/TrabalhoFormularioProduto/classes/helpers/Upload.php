<?php
    ...
    class Upload
    {
        ...
        /**
         * <b>Enviar Imagem:</b> Basta envelopar um $_FILES de uma imagem e caso queira um nome e uma largura
         * personalizada. Caso não informe a largura será 1024!
         *
        ...
        public function Image(array $Image, $Name = null, $Width = null, $Folder = null)
        {
            ...
            if (!in_array($this->Ext, $Extension) || !strstr($this->File["type"], 'image/')):
                $this->Result = false;
                $this->Error = "Tipo de imagem não aceito. Extenções aceitas: " . mb_strtoupper(str_replace(".", "",
                        implode(", ", $Extension))) . "!";
            else:
        ...
        /**
         * <b>Enviar Arquivo:</b> Basta envelopar um $_FILES de um arquivo e caso queira um nome e um tamanho
         * personalizado. Caso não informe o tamanho será 2mb!
         *
        ...
        public function File(array $File, $Name = null, $Folder = null, $MaxFileSize = null)
        {
            ...
            if (!in_array($this->Ext, $Extension) || !in_array($this->File['type'], $FileAccept)):
                $this->Result = false;
                $this->Error = "Tipo de arquivo não aceito. Extenções aceitas: " . mb_strtoupper(str_replace(".", "",
                        implode(", ", $Extension))) . "!";
        ...
        /**
         * <b>Enviar Mídia:</b> Basta envelopar um $_FILES de uma mídia e caso queira um nome e um tamanho
         * personalizado. Caso não informe o tamanho será 40mb!
         *
