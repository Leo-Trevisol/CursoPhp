...
<head>
    ...
    <link rel="base" href="https://localhost/php_class/Banco">
    <link rel='preconnect' href='https://fonts.googleapis.com'>
    <link rel='preconnect' href='https://fonts.gstatic.com' crossorigin>
    <link href='https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;600&display=swap' rel='stylesheet'>
    <link rel='stylesheet'href="_css/icomoon/demo-files/demos.css">
...
<div class="flex-box">
    <button class="btn btn-green btn-rounded" value="1" type="submit">
        <img class="ds_nome form_load" scr="images/load_w.gif" alt="enviando formulario!">Converter 
    </button>
</div>
</fieldset>
</form>
